...
**------------------------------------------------------------------------------
*/
void InstanceCommand( IDL_CTRL_HDL hCtrl, ABP_MsgType* psNewMessage )
{
   /*
...
**------------------------------------------------------------------------------
*/
void ObjectCommand( IDL_CTRL_HDL hCtrl, ABP_MsgType* psNewMessage )
{
   /*
...
void EPL_ProcessCmdMsg( IDL_CTRL_HDL hCtrl, ABP_MsgType* psNewMessage )
{
   /*
