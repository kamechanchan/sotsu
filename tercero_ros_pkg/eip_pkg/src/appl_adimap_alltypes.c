...
{
   { 20, "ABP_UINT32_READ",  ABP_UINT32, 1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_lUint32, NULL } }, NULL, NULL, NULL },
   { 21, "ABP_UINT32_WRITE", ABP_UINT32, 1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_lUint32, NULL } }, NULL, NULL, NULL },
   { 22, "ABP_SINT32_READ",  ABP_SINT32, 1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_lInt32,  NULL } }, NULL, NULL, NULL },
   { 23, "ABP_SINT32_WRITE", ABP_SINT32, 1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_lInt32,  NULL } }, NULL, NULL, NULL },
   { 24, "ABP_UINT16_READ",  ABP_UINT16, 1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_iUint16, NULL } }, NULL, NULL, NULL },
   { 25, "ABP_UINT16_WRITE", ABP_UINT16, 1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_iUint16, NULL } }, NULL, NULL, NULL },
   { 26, "ABP_SINT16_READ",  ABP_SINT16, 1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_iInt16,  NULL } }, NULL, NULL, NULL },
   { 27, "ABP_SINT16_WRITE", ABP_SINT16, 1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_iInt16,  NULL } }, NULL, NULL, NULL },
   { 28, "ABP_BITS16_READ",  ABP_BITS16, 1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_iBit16,  NULL } }, NULL, NULL, NULL },
   { 29, "ABP_BITS16_WRITE", ABP_BITS16, 1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_iBit16,  NULL } }, NULL, NULL, NULL },
   { 30, "ABP_UINT8_READ",   ABP_UINT8,  1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_bUint8,  NULL } }, NULL, NULL, NULL },
   { 31, "ABP_UINT8_WRITE",  ABP_UINT8,  1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_bUint8,  NULL } }, NULL, NULL, NULL },
   { 32, "ABP_SINT8_READ",   ABP_SINT8,  1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_bInt8,   NULL } }, NULL, NULL, NULL },
   { 33, "ABP_SINT8_WRITE",  ABP_SINT8,  1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_bInt8,   NULL } }, NULL, NULL, NULL },
   { 34, "ABP_UINT8_READ",   ABP_PAD8,   1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { NULL,          NULL } }, NULL, NULL, NULL },
   { 35, "ABP_UINT8_WRITE",  ABP_PAD8,   1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { NULL,          NULL } }, NULL, NULL, NULL },
   { 36, "ABP_BIT7_READ",    ABP_BIT7,   1,  APPL_READ_MAP_WRITE_ACCESS_DESC,  { { &appl_bBit8,   NULL } }, NULL, NULL, NULL },
   { 37, "ABP_BIT7_WRITE",   ABP_BIT7,   1,  APPL_WRITE_MAP_READ_ACCESS_DESC, { { &appl_bBit8,   NULL } }, NULL, NULL, NULL },
