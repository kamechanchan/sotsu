...
typedef void (*ABCC_LinkNotifyIndType)( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_LinkInit( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_LinkRunDriverRx( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_LinkWriteMessage( IDL_CTRL_HDL hCtrl, ABP_MsgType* psWriteMsg );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT16 ABCC_LinkGetNumCmdQueueEntries( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_LinkWrMsgWithNotification( IDL_CTRL_HDL hCtrl, ABP_MsgType* psWriteMsg,
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_LinkFree( IDL_CTRL_HDL hCtrl, ABP_MsgType** ppsBuffer );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_LinkMapMsgHandler( IDL_CTRL_HDL hCtrl, UINT8 bSrcId, ABCC_MsgHandlerFuncType  pnMSgHandler );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_MsgHandlerFuncType ABCC_LinkGetMsgHandler( IDL_CTRL_HDL hCtrl, UINT8 bSrcId );
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_LinkIsSrcIdUsed( IDL_CTRL_HDL hCtrl, UINT8 bSrcId );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABP_MsgType* ABCC_LinkReadMessage( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_LinkCheckSendMessage( IDL_CTRL_HDL hCtrl );
