...
********************************************************************************
*/
#define ABCC_PORT_DebugPrint( args ) OSIDL_Printf args

#define ABCC_PORT_UseCritical(hCtrl) IDL_UseCriticalImpl(hCtrl)

#define ABCC_PORT_EnterCritical(hCtrl) IDL_EnterCriticalImpl(hCtrl)

#define ABCC_PORT_ExitCritical(hCtrl) IDL_ExitCriticalImpl(hCtrl)
...
#define ABCC_PORT_MemCpy( pbDest, pbSource, iNbrOfOctets )                     \
        OSIDL_Memcpy( pbDest, pbSource, iNbrOfOctets );
