...
**------------------------------------------------------------------------------
*/
typedef void (*ABCC_MsgHandlerFuncType)( IDL_CTRL_HDL hCtrl, ABP_MsgType* psMsg );
...
#if( ABCC_CFG_64BIT_ADI_SUPPORT )
void ABCC_GetMsgData64( ABP_MsgType* psMsg, UINT64* pllData, UINT16 iOctetOffset );
void ABCC_SetMsgData64( ABP_MsgType* psMsg, UINT64 llData, UINT16 iOctetOffset );
#endif
...
EXTFUNC void ABCC_GpioReset( IDL_CTRL_HDL hCtrl );
#endif
...
*/
#if( ABCC_CFG_SYNC_MEASUREMENT_OP || ABCC_CFG_SYNC_MEASUREMENT_IP )
EXTFUNC void ABCC_GpioSet( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_HwInit( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_StartDriver( IDL_CTRL_HDL hCtrl, UINT32 lMaxStartupTimeMs );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_ShutdownDriver( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_CommunicationStateType ABCC_isReadyForCommunication( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_RunTimerSystem( IDL_CTRL_HDL hCtrl, const INT16 iDeltaTimeMs );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_HWReset( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_HWReleaseReset( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType (*ABCC_RunDriver)( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_UserInitComplete( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_SendCmdMsg( IDL_CTRL_HDL hCtrl,
                                            ABP_MsgType* psCmdMsg,
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT16 ABCC_GetCmdQueueSize( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_SendRespMsg( IDL_CTRL_HDL hCtrl,
                                             ABP_MsgType* psMsgResp );
...
EXTFUNC ABCC_ErrorCodeType ABCC_SendRemapRespMsg( IDL_CTRL_HDL hCtrl, 
                                                  ABP_MsgType* psMsgResp,
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABP_AppStatusType ABCC_GetAppStatus( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SetAppStatus( IDL_CTRL_HDL hCtrl,
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABP_MsgType* ABCC_GetCmdMsgBuffer( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_ReturnMsgBuffer( IDL_CTRL_HDL hCtrl, ABP_MsgType** ppsBuffer );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_TakeMsgBufferOwnership( IDL_CTRL_HDL hCtrl, ABP_MsgType* psMsg );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT8 ABCC_ReadModuleId( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_ModuleDetect( IDL_CTRL_HDL hCtrl );
...
EXTFUNC UINT16 ABCC_ModCap( IDL_CTRL_HDL hCtrl );
#endif
...
EXTFUNC UINT16 ABCC_LedStatus( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT8 ABCC_AnbState( IDL_CTRL_HDL hCtrl);
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_IsSupervised( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT16 ABCC_NetworkType( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT16 ABCC_ModuleType( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC NetFormatType ABCC_NetFormatType( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ParameterSupportType ABCC_ParameterSupport( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT8 ABCC_GetOpmode( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfEvent( IDL_CTRL_HDL hCtrl, UINT16 iEvents);
...
EXTFUNC void ABCC_CbfSyncIsr( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfUserInitReq( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfReceiveMsg( IDL_CTRL_HDL hCtrl, ABP_MsgType* psReceivedMsg );
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_CbfUpdateWriteProcessData( IDL_CTRL_HDL hCtrl, void* pxWritePd );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfNewReadPd( IDL_CTRL_HDL hCtrl, void* pxReadPd );
...
EXTFUNC void ABCC_CbfWdTimeout( IDL_CTRL_HDL hCtrl );
#endif
...
#if(  ABCC_CFG_DRV_SPI || ABCC_CFG_DRV_SERIAL ||           \
      ABCC_CFG_DRV_PARALLEL_30 )
EXTFUNC void ABCC_CbfWdTimeoutRecovered( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT16 ABCC_CbfAdiMappingReq( IDL_CTRL_HDL hCtrl,
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfDriverError(  IDL_CTRL_HDL hCtrl,
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CbfAnbStateChanged( IDL_CTRL_HDL hCtrl,
                                      ABP_AnbStateType bNewAnbState );
...
*/
#if( ABCC_CFG_REMAP_SUPPORT_ENABLED )
EXTFUNC void ABCC_CbfRemapDone( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_TriggerRdPdUpdate( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_TriggerReceiveMessage( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void (*ABCC_TriggerWrPdUpdate)( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_TriggerAnbStatusUpdate( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_TriggerTransmitMessage( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC UINT8 ABCC_GetNewSourceId( IDL_CTRL_HDL hCtrl );
