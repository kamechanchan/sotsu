...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SYS_ParallelRead( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset, void* pxData, UINT16 iLength );
...
EXTFUNC UINT8 ABCC_SYS_ParallelRead8( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
EXTFUNC UINT16 ABCC_SYS_ParallelRead16( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
EXTFUNC void ABCC_SYS_ParallelWrite( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset,
                                     void* pxData,
                                     UINT16 iLength );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
EXTFUNC void ABCC_SYS_ParallelWrite8( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset, UINT8 pbData );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
EXTFUNC void ABCC_SYS_ParallelWrite16( IDL_CTRL_HDL hCtrl, UINT16 iMemOffset, UINT16 iData );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
   EXTFUNC void* ABCC_SYS_ParallelGetRdPdBuffer( IDL_CTRL_HDL hCtrl );
#endif
...
*/
#if( !ABCC_CFG_MEMORY_MAPPED_ACCESS )
   EXTFUNC void* ABCC_SYS_ParallelGetWrPdBuffer( IDL_CTRL_HDL hCtrl );
#endif
