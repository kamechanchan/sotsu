...
**------------------------------------------------------------------------------
*/
EXTFUNC ABP_MsgType* ABCC_MemAlloc( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_MemFree( IDL_CTRL_HDL hCtrl, ABP_MsgType** pxItem);
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_MemBufferStatusType ABCC_MemGetBufferStatus( IDL_CTRL_HDL hCtrl, ABP_MsgType* psMsg );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_MemSetBufferStatus( IDL_CTRL_HDL hCtrl, ABP_MsgType* psMsg,
