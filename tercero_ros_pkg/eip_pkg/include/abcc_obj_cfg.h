...
*/
#ifndef EIP_IA_PROD_INSTANCE_ENABLE    // instance_no_output
   #define EIP_IA_PROD_INSTANCE_ENABLE             TRUE
   #define EIP_IA_PROD_INSTANCE_VALUE              { 101 } /* default 0x0064 (= 100) */
...
*/
#ifndef EIP_IA_CONS_INSTANCE_ENABLE    // instance_no_input
   #define EIP_IA_CONS_INSTANCE_ENABLE             TRUE
   #define EIP_IA_CONS_INSTANCE_VALUE              { 102 } /* default 0x0096 (= 150) */
