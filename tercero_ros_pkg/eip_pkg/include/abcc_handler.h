...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SetPdSize( IDL_CTRL_HDL hCtrl, const UINT16 iReadPdSize, const UINT16 iWritePdSize );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SetReadyForCommunication( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SetMainStateError( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_MainStateType ABCC_GetMainState( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_CheckWrPdUpdate( IDL_CTRL_HDL hCtrl );
