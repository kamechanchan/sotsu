...
EXTFUNC void ABCC_SYS_AbccInterruptEnable( IDL_CTRL_HDL hCtrl );
#endif
...
*/
#if( ABCC_CFG_INT_ENABLED )
EXTFUNC void ABCC_SYS_AbccInterruptDisable( IDL_CTRL_HDL hCtrl );
#endif
...
EXTFUNC void ABCC_SYS_SyncInterruptEnable( IDL_CTRL_HDL hCtrl );
#endif
...
*/
#if( ABCC_CFG_SYNC_ENABLE && ABCC_CFG_USE_ABCC_SYNC_SIGNAL )
EXTFUNC void ABCC_SYS_SyncInterruptDisable( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SYS_HWReset( IDL_CTRL_HDL hCtrl );
...
**-------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SYS_HWReleaseReset( IDL_CTRL_HDL hCtrl );
...
EXTFUNC BOOL ABCC_SYS_IsAbccInterruptActive( IDL_CTRL_HDL hCtrl );
#endif

/*------------------------------------------------------------------------------
** Read Module Identification pins on the host connector.
** If the identification pins are not connected the ABCC_CFG_ABCC_MODULE_ID
** definition must be set in abcc_drv_cfg.h with the correct value
** corresponding to the used device.
**
** Valid return values:
...
EXTFUNC UINT8 ABCC_SYS_ReadModuleId( IDL_CTRL_HDL hCtrl );
#endif
...
EXTFUNC void ABCC_SYS_SetOpmode( IDL_CTRL_HDL hCtrl, UINT8 bOpMode );
#endif
...
EXTFUNC UINT8 ABCC_SYS_GetOpmode( IDL_CTRL_HDL hCtrl );
#endif
...
EXTFUNC BOOL ABCC_SYS_ModuleDetect( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_SYS_HwInit( IDL_CTRL_HDL hCtrl );
...
EXTFUNC void ABCC_SYS_GpioReset( IDL_CTRL_HDL hCtrl );
#endif
...
*/
#if ( ABCC_CFG_SYNC_MEASUREMENT_OP || ABCC_CFG_SYNC_MEASUREMENT_IP )
EXTFUNC void ABCC_SYS_GpioSet( IDL_CTRL_HDL hCtrl );
#endif
...
**------------------------------------------------------------------------------
*/
EXTFUNC BOOL ABCC_SYS_Init( IDL_CTRL_HDL hCtrl );
...
**------------------------------------------------------------------------------
*/
EXTFUNC void ABCC_SYS_Close( IDL_CTRL_HDL hCtrl );
 ...
 *************************************************************************************************/
EXTFUNC BOOL ABCC_SYS_SetPDSize ( IDL_CTRL_HDL hCtrl, const UINT16 iReadPdSize, const UINT16 iWritePdSize  );
