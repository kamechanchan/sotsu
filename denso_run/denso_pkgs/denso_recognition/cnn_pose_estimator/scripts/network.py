...
class CNN(chainer.Chain):
    ...
    def __init__(self):
        super(CNN, self).__init__(
            ...
            l_pos=L.Linear(1000, output_pos_num),

            l_ori1=L.Linear(None, 1000),
            l_ori2=L.Linear(1000, 500),
            l_ori3=L.Linear(500, 200),
            l_ori=L.Linear(200, output_ori_num),
        )

    def __call__(self, x, t):
        h = self.fwd(x)
# loss = F.mean_squared_error(h, t[:,3:7])
# loss = F.mean_squared_error(h, t[:,0:3])
