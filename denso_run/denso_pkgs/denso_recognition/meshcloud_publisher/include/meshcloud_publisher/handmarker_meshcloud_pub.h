#ifndef HANDMARKER_MESHCLOUD_PUB_H
#define HANDMARKER_MESHCLOUD_PUB_H
...
namespace handmarker_meshcloud_pub
{
class HandMarkerMeshCloudPub
{
public:
  HandMarkerMeshCloudPub(ros::NodeHandle& nh);
  ~HandMarkerMeshCloudPub()
  {
  }
...
#endif  // HANDMARKER_MESHCLOUD_PUB_H
