...
class CloudDownsamper : public CloudOperator
{
  public:
    CloudDownsamper(ros::NodeHandle &nh) :
      cloud_pub_(nh.advertise<sensor_msgs::PointCloud2>("/photoneo/cloud_downsampled", 1))
  {}
    ...
    void operate()
    {
      ...
      voxelSampler.setLeafSize(0.002f, 0.002f, 0.002f);
...
main(int argc, char **argv)
{
  ...
  CloudOperationHandler handler(nh, new CloudDownsamper(nh), "/photoneo_center/pointcloud");
