...
with h5py.File('/home/ericlab/ros_package/denso_ws/src/denso_run/rikuken_original/annotation_package/dataset/instance_tsuchida_10000_8_7_5_12.hdf5', mode="r") as f:
    for n in range(1526):
        ...
        for i in range(resolution):
            ...
            # print(original_data.shape)
            # print(i)
            if original_data[i, 3] == 25:
                original_data[i, 3] = 1
                # cnt -= 1
                # print(i)
            else:
                original_data[cnt, 3] = 0
                # cnt -= 1
                # print(i)
        print(original_data.shape)
...
with h5py.File('/home/ericlab/ros_package/denso_ws/src/denso_run/rikuken_original/annotation_package/dataset/tsuchida/semantic_changed_1526.hdf5', 'w') as file:
