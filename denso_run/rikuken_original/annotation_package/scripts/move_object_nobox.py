    ...
    def object_move(self, name):
        ...
        for i in range(25):
                ...
                if i == 0:
                    ...
                    pose_data.pose.position.z = random.uniform(0.00, 0.1)
                    ...
                    # pose_data.pose.position.x = random.uniform(a_1, a_5)
                    # pose_data.pose.position.y = random.uniform(a_1, a_5)
                    pose_data.pose.position.z = random.uniform(0.00, 0.05)
                    ...
                    # pose_data.pose.position.x = random.uniform(a_1, a_5)
                    # pose_data.pose.position.y = random.uniform(a_1, a_5)
                    pose_data.pose.position.z = random.uniform(0.00, 0.04)
                    ...
                    # pose_data.pose.position.x = random.uniform(a_1, a_5)
                    # pose_data.pose.position.y = random.uniform(a_1, a_5)
                    pose_data.pose.position.z = random.uniform(0.00, 0.01)
                    # pose_data.pose.position.x = random.uniform(-0.04, 0.00)
                    ...
                    # pose_data.pose.position.x = random.uniform(a_1, a_5)
                    # pose_data.pose.position.y = random.uniform(a_1, a_5)
                    pose_data.pose.position.z = random.uniform(0.00, 0.02)
                    # pose_data.pose.position.x = random.uniform(0.04, 0.08)
                    # pose_data.pose.position.y = random.uniform(0.02, 0.06)
                    ...
                    # pose_data.pose.position.x = random.uniform(a_1, a_5)
                    # pose_data.pose.position.y = random.uniform(a_1, a_5)
                    pose_data.pose.position.z = random.uniform(0.00, 0.03)
                elif i == 22:
                    pose_data.pose.position.x = a_5
                    pose_data.pose.position.y = a_3
