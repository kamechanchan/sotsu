...
int main(int argc, char** argv)
{
    ...
    arm_hand.set_close_range(0.01953);
    ...
    pon1 = arm_hand.get_pose_tf("base_link", "world");
    pon2 = arm_hand.get_pose_tf("HV8_0", "world");
    pon.x = pon2.x - pon1.x;
    pon.y = pon2.y - pon1.y;

    geometry_msgs::TransformStamped final_tf;
    final_tf = arm_hand.get_pose_tf("HV8", "world", 0.08);
    pon.x = final_tf.transform.translation.x - pon1.x;
    pon.y = final_tf.transform.translation.y - pon1.y;
