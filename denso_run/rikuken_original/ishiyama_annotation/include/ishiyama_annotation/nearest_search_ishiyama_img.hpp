...
#include <estimator/third_input.h>
...
namespace nearest_point_extractor_ishiyama
{
    ...
    public:
        ...
        bool InputCallback(estimator::third_input::Request& req, estimator::third_input::Response& res);
    ...
    private:
        ...
        std::string img_service_name_;
        std::string main_service_name_;
        std::string photoneo_frame_id_;
        std::vector<std::vector<int>> color;
        double radius;

        pcl::PointCloud<pcl::PointXYZ> tem_cloud_;
        sensor_msgs::PointCloud2 fav_cloud_;
    };
}