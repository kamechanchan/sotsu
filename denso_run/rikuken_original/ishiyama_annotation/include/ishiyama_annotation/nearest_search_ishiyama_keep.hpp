...
#include <estimator/second_input.h>
#include <estimator/nearest_mesh.h>
...
namespace nearest_point_extractor_ishiyama
{
    ...
    public:
        ...
        void publish();
        bool InputCallback(estimator::second_input::Request& req, estimator::second_input::Response& res);
    ...
    private:
        ...
        ros::ServiceServer server_for_clientmain_;
        ros::ServiceClient client_for_mesh_;
        ...
        std::string photoneo_sensor_img_;
        std::string main_service_name_;
        std::string NearMesh_service_name_;
        std::vector<std::vector<int>> color;
        double radius;

        estimator::nearest_mesh nearest_mesh_srv_;
