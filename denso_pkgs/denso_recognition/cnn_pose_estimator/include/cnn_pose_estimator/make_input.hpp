...
public:
  ...
  void getVoxelSize(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud);
  void downsampleCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, pcl::PointCloud<pcl::PointXYZRGB>::Ptr output,
                       float leaf);
...
private:
  ...
  pcl::PointXYZRGB voxel_min_, voxel_max_;
